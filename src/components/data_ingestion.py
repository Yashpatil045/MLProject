## This file reads the data from the source, saves it to the destination,
...
if __name__ == "__main__":
    ...
    data_transformation = DataTransformation(target_column="math_score")  # change target if needed
